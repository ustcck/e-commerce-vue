...
describe('Shipment e2e test', () => {
  ...
  describe('Create flow', () => {
    ...
    /* it('should create and save Shipments', async () => {
      ...
      expect(await updatePage.trackingCodeInput.getAttribute('value')).to.match(/trackingCode/);
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      it('should load edit Shipment page, fetch data and update', async () => {
        ...
        expect(await updatePage.title.getText()).not.to.be.empty;
          ...
          expect(await updatePage.trackingCodeInput.getAttribute('value')).to.match(/modified/);
