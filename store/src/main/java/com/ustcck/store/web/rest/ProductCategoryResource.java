...
import com.ustcck.store.domain.ProductCategory;
import com.ustcck.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.ustcck.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
