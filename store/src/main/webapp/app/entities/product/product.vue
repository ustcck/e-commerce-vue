    ...
    <div>
        ...
        <div class="table-responsive" v-if="products && products.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th v-on:click="changeOrder('name')"><span v-text="$t('storeApp.product.name')">Name</span> <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator></th>
                    <th v-on:click="changeOrder('description')"><span v-text="$t('storeApp.product.description')">Description</span> <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'description'"></jhi-sort-indicator></th>
                    <th v-on:click="changeOrder('price')"><span v-text="$t('storeApp.product.price')">Price</span> <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'price'"></jhi-sort-indicator></th>
                    <th v-on:click="changeOrder('size')"><span v-text="$t('storeApp.product.size')">Size</span> <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'size'"></jhi-sort-indicator></th>
                    <th v-on:click="changeOrder('image')"><span v-text="$t('storeApp.product.image')">Image</span> <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'image'"></jhi-sort-indicator></th>
                    <th v-on:click="changeOrder('productCategory.name')"><span v-text="$t('storeApp.product.productCategory')">Product Category</span> <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'productCategory.name'"></jhi-sort-indicator></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-product-heading" v-text="$t('storeApp.product.delete.question', {'id': removeId})">Are you sure you want to delete this Product?</p>
            </div>
