    ...
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-productCategory-heading" v-text="$t('storeApp.productCategory.delete.question', {'id': removeId})">Are you sure you want to delete this Product Category?</p>
            </div>
