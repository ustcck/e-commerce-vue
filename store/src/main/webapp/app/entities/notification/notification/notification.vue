    ...
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            ...
            <div class="modal-body">
                <p id="jhi-delete-notification-heading" v-text="$t('storeApp.notificationNotification.delete.question', {'id': removeId})">Are you sure you want to delete this Notification?</p>
            </div>
