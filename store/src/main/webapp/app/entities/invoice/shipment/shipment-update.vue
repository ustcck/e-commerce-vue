            ...
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="shipment-invoice" name="invoice" v-model="shipment.invoice" required>
                            <option v-if="!shipment.invoice" v-bind:value="null" selected></option>
                            <option v-bind:value="shipment.invoice && invoiceOption.id === shipment.invoice.id ? shipment.invoice : invoiceOption" v-for="invoiceOption in invoices" :key="invoiceOption.id">{{invoiceOption.code}}</option>
                        </select>
                    </div>
