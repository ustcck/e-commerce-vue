...
import com.ustcck.invoice.domain.Shipment;
import com.ustcck.invoice.service.ShipmentService;
import com.ustcck.invoice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.ustcck.invoice.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
